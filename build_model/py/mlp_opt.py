...
def main():
    parser = argparse.ArgumentParser(description='Tune MLPClassifier')
    ...
    param_grid = {'hidden_layer_sizes':[(1000, 1000, 1000, ), (1000, 1000, ),
                                        (1000, ), (1000, 1000, 100, ),
                                        (1000, 100, ), (100, )]}
    ...
    results.columns = ['micro_AUROC', 'macro_AUROC', 'Frac_1_in_top10',
                       ...
                       + list(params)
    results.to_csv(args['output'][0] + '/' + 'MLP_opt_results.csv',
                   index=False)
